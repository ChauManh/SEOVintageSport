const mockProducts = [
  ...
  },
  {
    ...
    description:
      "Áo đấu Liverpool mùa giải 2004-2005, mùa giải mà The Kop có màn lội ngược dòng kỳ diệu tại chung kết Champions League trước AC Milan. Thiết kế đơn giản, logo Carlsberg và phong cách vintage.",
  },
  {
    id: "10",
    ...
    description:
      "Áo đấu Juventus mùa giải 1995-1996, năm mà Lão Bà vô địch Champions League sau khi đánh bại Ajax. Thiết kế sọc trắng đen truyền thống, logo Sony tài trợ và phong cách retro.",
  },
];
